	...
	public chat() {
		...
		////chat
		  ...
		  panel = new JPanel();
	        ...
	        panel.setBounds(1108, 122, 426, 498);
	        contentPane.add(panel);

	        textArea = new JTextArea();
	        textArea.setBounds(20, 47, 396, 200);
	        panel.add(textArea);
	        ...
	        textsend.setBounds(54, 305, 348, 46);
	        panel.add(textsend);

	        send = new JButton("Send");
	        send.setBounds(176, 403, 77, 37);
	        panel.add(send);
	        //chat
		...
		try {
		    ...
		    OffChat.setBounds(1226, 8, 102, 25);
		    contentPane.add(OffChat);
		    
		    

		} catch (UnknownHostException ex) {
		    // Xử lý ngoại lệ nếu không thể lấy địa chỉ IP của máy
		    ex.printStackTrace();
		}
